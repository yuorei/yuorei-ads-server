...
type OrganizationInputPort interface {
	CreateOrganization(ctx context.Context, organizationID, clientID, ClientSecret string) (*domain.Organization, error)
...
type OrganizationRepository interface {
	DBCreateOrganization(ctx context.Context, organizationID, clientID, ClientSecret string) (*domain.Organization, error)
